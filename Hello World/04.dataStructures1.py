...
print("-" * 20 + "\n Looping over lists \n" + "-" * 20)
letters = ["a", "b", "c"]
# if we need index as well - returns tuple
...
print(letters)
# remove an element (first appearance) if index is not known
letters.remove("b")
print(letters)
...
# Map function
print("-" * 20 + "\n Map function \n" + "-" * 20)
# create map from the products, create list from iterable map
